...
export default function AdminCards_4(props) {
  ...
  return (
    <div class="container w-full h-80 rounded overflow-hidden shadow-lg ">
        <div class="heading text-left m-5 text-2xl"> {props.buttonType} {props.cardtype=="Minter"? props.cardtype:"Crowdsale"}</div>
        ...
        <div class=" p-5 pt-2">
        <button class={props.buttonType=="Unpause"? "bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded":"bg-red-500 hover:bg-red-700 text-white font-bold py-2 px-4 rounded" } onClick={handlebuttonClick}>{props.buttonType} {props.cardtype=="Minter"? props.cardtype:"Crowdsale"}</button>
        </div>
